...
public class CookieUtil {
    ...
    public static Cookie createCookie(String name, String value, int maxAge) {
        ...
        cookie.setDomain("api.podofarm.xyz"); // 도메인 설정
    ...
    public static void deleteRefreshTokenCookie(HttpServletResponse response) {
        ...
        myCookie.setDomain("api.podofarm.xyz");
        myCookie.setAttribute("SameSite", "None");
        response.addCookie(myCookie);
        response.setHeader("Set-Cookie", "RefreshToken=; Path=/; Domain=api.podofarm.xyz; Max-Age=0; Secure; HttpOnly; SameSite=None");
    }
